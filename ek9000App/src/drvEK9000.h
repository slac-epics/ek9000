...
public:
	 ...
	 * pbuf should point to a VALID buffer to either receive or write data. It's size should == bytesize. Be careful of
	 * buffer overruns
	 */
	bool doCoEIO(bool rw, epicsUInt16 termid, epicsUInt16 index, epicsUInt16 subindex, epicsUInt16 bytesize,
				 epicsUInt16* pbuf);
